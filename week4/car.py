...
def fill(gasTankSize, gasToBeFilled, gasCurrently):
    """
...
def calculateDistance(curX, curY, destX, destY):
    """calculates distance to be driven with x and y coordinates"""
    distToBeDriven = sqrt((destX-curX)**2 + (destY-curY)**2)
    
    return distToBeDriven
